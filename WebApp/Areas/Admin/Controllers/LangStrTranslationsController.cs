...
namespace WebApp.Areas.Admin.Controllers
{
    ...
    public class LangStrTranslationsController : Controller
    {
        ...
        {
            var vm = new LangStrTranslationViewModel()
            {
                LanguageStringTranslationSelectList =
                    new SelectList(_context.LangStrs, "Id", "Id")
            };
            return View(vm);
        }
        ...
        public async Task<IActionResult> Create([Bind("Culture,Value,LangStrId,CreatedBy,CreatedAt,ChangedBy,ChangedAt,Id")] LangStrTranslation langStrTranslation)
        {
            ...
            var vm = new LangStrTranslationViewModel()
            {
                LanguageStringTranslation = langStrTranslation,
                LanguageStringTranslationSelectList =
                    new SelectList(_context.LangStrs, "Id", "Id", langStrTranslation.LangStrId)
            };
